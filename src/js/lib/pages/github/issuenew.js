...
export default function () {
    ...
    IssueNewPage.setup = function () {
        $('.k2picker-wrapper, .k2pickerarea-wrapper, .k2pickertype-wrapper, .k2togglereviewing-wrapper, .k2comments-wrapper, .k2previousissues-wrapper, .k2request-wrapper').remove();
    };
